...
%include "xvidcore/colorspace_mmx.inc"

; input
MAKE_COLORSPACE  _bgr_to_yv12_mmx,0,    3,2,2,  BGR_TO_YV12,  3, -1
MAKE_COLORSPACE  _bgra_to_yv12_mmx, 0, 4, 2, 2, BGR_TO_YV12, 4, -1
MAKE_COLORSPACE  _rgb_to_yv12_mmx, 0, 3, 2, 2, RGB_TO_YV12, 3, -1
MAKE_COLORSPACE  _rgba_to_yv12_mmx, 0, 4, 2, 2, RGB_TO_YV12, 4, -1

; output
MAKE_COLORSPACE  _yv12_to_bgr_mmx, 48, 3, 8, 2, YV12_TO_BGR, 3, -1
MAKE_COLORSPACE  _yv12_to_bgra_mmx, 48, 4, 8, 2, YV12_TO_BGR, 4, -1
