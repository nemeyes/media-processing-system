...
class dkIDirect3DDevice9Ex : public IDirect3DDevice9Ex
{
public:
	dkIDirect3DDevice9Ex(IDirect3DDevice9Ex* pDevice, IDirect3D9Ex* pCreatedBy);
	virtual ~dkIDirect3DDevice9Ex(void);
