...
dk_aac_encoder::ERR_CODE faac_encoder::encode(dk_audio_entity_t * pcm, dk_audio_entity_t * encoded)
{
#if 0	
...
dk_aac_encoder::ERR_CODE faac_encoder::get_queued_data(dk_audio_entity_t * encoded)
{
	if (_front)
	{
