...
namespace debuggerking
{
	...
	public:
		...
		static HRESULT add_branch_to_partial_topology(IMFTopology * topology, IMFMediaSource * media_source, DWORD stream_index, IMFPresentationDescriptor * present_descriptor, mf_player_framework::configuration_t * config, IUnknown ** device_manager, IKeyEvent ** keyevent);
