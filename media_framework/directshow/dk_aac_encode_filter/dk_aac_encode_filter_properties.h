...
class dk_aac_encode_filter_properties : public CBasePropertyPage
{
public:
	dk_aac_encode_filter_properties(LPUNKNOWN pUnk);
	virtual ~dk_aac_encode_filter_properties(VOID);
