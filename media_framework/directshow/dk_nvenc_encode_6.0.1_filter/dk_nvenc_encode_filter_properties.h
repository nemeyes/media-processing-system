...
class dk_nvenc_encode_filter_properties : public CBasePropertyPage
{
public:
	dk_nvenc_encode_filter_properties(LPUNKNOWN pUnk);
	virtual ~dk_nvenc_encode_filter_properties(void);
