...
class dk_celt_encode_filter_properties : public CBasePropertyPage
{
public:
	dk_celt_encode_filter_properties(LPUNKNOWN pUnk);
	virtual ~dk_celt_encode_filter_properties(VOID);
