...
// the default child constructor...
  dk_screencapture_filter_stream::dk_screencapture_filter_stream(HRESULT *phr, dk_screencapture_filter *pFilter)
	: CSourceStream( NAME("dk_screencapture_filter_stream"), phr, pFilter, L"Capture")
	, m_bReReadRegistry(0)
	, m_bDeDupe(0)
	, m_iFrameNumber(0)
	, pOldData(NULL)
...
HRESULT dk_screencapture_filter_stream::FillBuffer(IMediaSample *pSample)
{
...
float dk_screencapture_filter_stream::GetFps() 
{
	return (float) (UNITS / m_rtFrameLength);
}

void dk_screencapture_filter_stream::reReadCurrentPosition(int isReRead)
{
...
dk_screencapture_filter_stream::~dk_screencapture_filter_stream()
{   
...
void dk_screencapture_filter_stream::CopyScreenToDataBlock(HDC hScrDC, BYTE *pData, BITMAPINFO *pHeader, IMediaSample *pSample)
{
...
void dk_screencapture_filter_stream::doJustBitBltOrScaling(HDC hMemDC, int nWidth, int nHeight, int iFinalWidth, int iFinalHeight, HDC hScrDC, int nX, int nY) {
	__int64 start = StartCounter();
...
int dk_screencapture_filter_stream::getNegotiatedFinalWidth() 
{
...
int dk_screencapture_filter_stream::getNegotiatedFinalHeight() 
{
...
int dk_screencapture_filter_stream::getCaptureDesiredFinalWidth() 
{
...
int dk_screencapture_filter_stream::getCaptureDesiredFinalHeight()
{
...
void dk_screencapture_filter_stream::doDIBits(HDC hScrDC, HBITMAP hRawBitmap, int nHeightScanLines, BYTE *pData, BITMAPINFO *pHeader) 
{
	__int64 start = StartCounter();
...
//
HRESULT dk_screencapture_filter_stream::DecideBufferSize( IMemAllocator *pAlloc, ALLOCATOR_PROPERTIES *pProperties )
{
...
HRESULT dk_screencapture_filter_stream::OnThreadCreate() 
{
...
HRESULT dk_screencapture_filter_stream::CheckMediaType(const CMediaType *pMediaType)
{
	CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT dk_screencapture_filter_stream::SetMediaType(const CMediaType *pMediaType)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT STDMETHODCALLTYPE dk_screencapture_filter_stream::SetFormat(AM_MEDIA_TYPE *pmt)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT STDMETHODCALLTYPE dk_screencapture_filter_stream::GetFormat(AM_MEDIA_TYPE **ppmt)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT STDMETHODCALLTYPE dk_screencapture_filter_stream::GetNumberOfCapabilities(int *piCount, int *piSize)
{
    *piCount = 7;
...
HRESULT STDMETHODCALLTYPE dk_screencapture_filter_stream::GetStreamCaps(int iIndex, AM_MEDIA_TYPE **pmt, BYTE *pSCC)
{
    CAutoLock cAutoLock(m_pFilter->pStateLock());
...
HRESULT dk_screencapture_filter_stream::QuerySupported(REFGUID guidPropSet, DWORD dwPropID, DWORD *pTypeSupport)
{
...
HRESULT dk_screencapture_filter_stream::QueryInterface(REFIID riid, void **ppv)
{   
...
// IKsPropertySet
//////////////////////////////////////////////////////////////////////////
HRESULT dk_screencapture_filter_stream::Set(REFGUID guidPropSet, DWORD dwID, void *pInstanceData, DWORD cbInstanceData, void *pPropData, DWORD cbPropData)
{
...
HRESULT dk_screencapture_filter_stream::Get(
...
//
HRESULT dk_screencapture_filter_stream::GetMediaType(int iPosition, CMediaType *pmt) // AM_MEDIA_TYPE basically == CMediaType
{
