...
class dk_dxva2_decode_filter_properties : public CBasePropertyPage
{
public:
	dk_dxva2_decode_filter_properties(LPUNKNOWN pUnk);
	virtual ~dk_dxva2_decode_filter_properties(VOID);
