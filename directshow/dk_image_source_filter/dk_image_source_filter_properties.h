...
class dk_image_source_filter_properties : public CBasePropertyPage
{
public:
	dk_image_source_filter_properties(LPUNKNOWN unk);
	virtual ~dk_image_source_filter_properties(void);
