...
class dk_rtmp_video_source_stream : public CSourceStream, public IAMPushSource
{
	DECLARE_IUNKNOWN;
	friend class dk_rtmp_source_filter;
public:
	dk_rtmp_video_source_stream(HRESULT * hr, CSource * ms, LPCWSTR name);
	virtual ~dk_rtmp_video_source_stream(void);
