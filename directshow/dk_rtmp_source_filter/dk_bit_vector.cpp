...
dk_bit_vector::dk_bit_vector(unsigned char* baseBytePtr, unsigned baseBitOffset, unsigned totNumBits)
{
	setup(baseBytePtr, baseBitOffset, totNumBits);
}

void dk_bit_vector::setup(unsigned char* baseBytePtr, unsigned baseBitOffset, unsigned totNumBits)
{
...
void dk_bit_vector::putBits(unsigned from, unsigned numBits)
{
	if (numBits == 0)
		return;
...
void dk_bit_vector::put1Bit(unsigned bit)
{
...
unsigned dk_bit_vector::getBits(unsigned numBits)
{
	if (numBits == 0)
		return 0;
...
unsigned dk_bit_vector::get1Bit()
{
...
void dk_bit_vector::skipBits(unsigned numBits)
{
	if (numBits > fTotNumBits - fCurBitIndex)
	{ /* overflow */
...
unsigned dk_bit_vector::get_expGolomb()
{
