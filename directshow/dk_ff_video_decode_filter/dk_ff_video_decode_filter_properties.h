...
class dk_ff_video_decode_filter_properties : public CBasePropertyPage
{
public:
	dk_ff_video_decode_filter_properties(LPUNKNOWN pUnk);
	virtual ~dk_ff_video_decode_filter_properties(void);
