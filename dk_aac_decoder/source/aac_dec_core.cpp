...
aac_dec_core::aac_dec_core(void)
	: _aac_decoder(0)
	, _aac_config(0)
	, _buffer(0)
	, _buffer_size(0)
...
dk_aac_decoder::ERR_CODE aac_dec_core::initialize(dk_aac_decoder::configuration_t config, unsigned char * extra_data, int extra_data_size, int & samplerate, int & channels)
{
	_config = config;
...
dk_aac_decoder::ERR_CODE aac_dec_core::release(void)
{
	if (_aac_decoder)
	{
...
dk_aac_decoder::ERR_CODE aac_dec_core::decode(unsigned char * input, unsigned int isize, unsigned char * output, unsigned int & osize)
{
	if (!_aac_decoder)
		return dk_aac_decoder::ERR_CODE_FAILED;
