...
namespace debuggerking
{
	...
	class parallel_recorder_controller : public ic::dk_ipc_client
	{
	public:
		parallel_recorder_controller(parallel_recorder_t * parallel_recorder);
		virtual ~parallel_recorder_controller(void);
