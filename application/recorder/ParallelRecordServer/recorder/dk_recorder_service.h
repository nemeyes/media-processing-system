...
namespace debuggerking
{
	...
	public:
		...
		static recorder_service & instance(void);
	...
	private:
		recorder_service(void);
		virtual ~recorder_service(void);
	...
	private:
		...
		std::vector<recorder_service::recorder_receiver_information_t> _receivers;
