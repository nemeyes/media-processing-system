#ifndef _PTZ_MODULE_LOADER_H_
#define _PTZ_MODULE_LOADER_H_
#include <pthread.h>
...
class ptz_module_mapper
{
public:
	static ptz_module_mapper & instance( void );
...
private:
	void load( void );
	ptz_module_mapper( void );
	~ptz_module_mapper( void );

	vendors		_ptz_vendors;
	bool		_is_mapped;
