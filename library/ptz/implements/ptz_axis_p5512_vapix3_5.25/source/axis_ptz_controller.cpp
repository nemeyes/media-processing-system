...
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512_VAPIX_V3_5_25][VENDOR];
}

char* axis_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512_VAPIX_V3_5_25][DEVICE];
}

char* axis_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512_VAPIX_V3_5_25][PROTOCOL];
}

char* axis_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512_VAPIX_V3_5_25][VERSION];
}

unsigned short axis_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[AXIS_P5512_VAPIX_V3_5_25][VENDOR];
}

unsigned short axis_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[AXIS_P5512_VAPIX_V3_5_25][DEVICE];
}

unsigned short axis_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[AXIS_P5512_VAPIX_V3_5_25][PROTOCOL];
}

unsigned short axis_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[AXIS_P5512_VAPIX_V3_5_25][VERSION];
}
