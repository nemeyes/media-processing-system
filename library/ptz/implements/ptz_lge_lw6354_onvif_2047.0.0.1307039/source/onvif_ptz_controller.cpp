...
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW6354_ONVIF_2047_0_0_1307039][VENDOR];
}

char* onvif_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW6354_ONVIF_2047_0_0_1307039][DEVICE];
}

char* onvif_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW6354_ONVIF_2047_0_0_1307039][PROTOCOL];
}

char* onvif_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW6354_ONVIF_2047_0_0_1307039][VERSION];
}

unsigned short onvif_ptz_controller::get_vendor_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW6354_ONVIF_2047_0_0_1307039][VENDOR];
}

unsigned short onvif_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW6354_ONVIF_2047_0_0_1307039][DEVICE];
}

unsigned short onvif_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW6354_ONVIF_2047_0_0_1307039][PROTOCOL];
}

unsigned short onvif_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW6354_ONVIF_2047_0_0_1307039][VERSION];
}
