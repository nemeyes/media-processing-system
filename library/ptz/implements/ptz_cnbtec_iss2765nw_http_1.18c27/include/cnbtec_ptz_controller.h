...
class http_client;
#if defined(WIN32)
class __declspec(dllexport) cnbtec_ptz_controller : public base_ptz_controller
#else
class cnbtec_ptz_controller : public base_ptz_controller
#endif
{
public:
	cnbtec_ptz_controller( void );
	~cnbtec_ptz_controller( void );
