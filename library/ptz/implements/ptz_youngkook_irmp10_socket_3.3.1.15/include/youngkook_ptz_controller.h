...
#if defined(WIN32)
class __declspec(dllexport) youngkook_ptz_controller : public base_ptz_controller
#else
class youngkook_ptz_controller : public base_ptz_controller
#endif
{
public:
	youngkook_ptz_controller( void );
	~youngkook_ptz_controller( void );
...
private:
	...
	unsigned short  send_data(std::string cmd, int data1=0, int data2=0);
	unsigned short  show_osd(bool show);
