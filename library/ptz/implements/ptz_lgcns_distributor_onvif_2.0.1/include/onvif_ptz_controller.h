...
private:
	...
	SOAP_CLIENT_FUNC( GetPresetTours, onvif_ptz_controller, PTZBindingProxy, char*, _tptz__GetPresetTours*, _tptz__GetPresetToursResponse* )
	SOAP_CLIENT_FUNC( GetPresetTour, onvif_ptz_controller, PTZBindingProxy, char*, _tptz__GetPresetTour*, _tptz__GetPresetTourResponse* )
	SOAP_CLIENT_FUNC( CreatePresetTour, onvif_ptz_controller, PTZBindingProxy, char*, _tptz__CreatePresetTour*, _tptz__CreatePresetTourResponse* )
	SOAP_CLIENT_FUNC( ModifyPresetTour, onvif_ptz_controller, PTZBindingProxy, char*, _tptz__ModifyPresetTour*, _tptz__ModifyPresetTourResponse* )
	SOAP_CLIENT_FUNC( OperatePresetTour, onvif_ptz_controller, PTZBindingProxy, char*, _tptz__OperatePresetTour*, _tptz__OperatePresetTourResponse* )
	SOAP_CLIENT_FUNC( RemovePresetTour, onvif_ptz_controller, PTZBindingProxy, char*, _tptz__RemovePresetTour*, _tptz__RemovePresetTourResponse* )
	SOAP_CLIENT_FUNC( GetPTZProperties, onvif_ptz_controller, IntelliVMSBindingProxy, char*, ns1__GetPTZPropertiesRequest*, ns1__GetPTZPropertiesResponse* )

	unsigned short  query_properties( void );
...
private:
	...
	bool				_is_properties_queried;
	bool				_is_limits_queried;
	bool				_is_inverse;

	bool				_is_osd_menu;
	bool				_is_home_position;
	bool				_is_preset;
	bool				_is_preset_tour;
	bool				_is_continuous_move;
	bool				_is_relative_move;
	bool				_is_absolute_move;
	bool				_is_numberic_preset_name;
	bool				_is_numberic_preset_tour_name;	
	bool				_is_changable_preset_name;
	bool				_is_changable_preset_tour_name;	
};
