...
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2810_SOAP_API_1889_0_0_1304190][VENDOR];
}

char* lge_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2810_SOAP_API_1889_0_0_1304190][DEVICE];
}

char* lge_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2810_SOAP_API_1889_0_0_1304190][PROTOCOL];
}

char* lge_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2810_SOAP_API_1889_0_0_1304190][VERSION];
}

unsigned short lge_ptz_controller::get_vendor_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2810_SOAP_API_1889_0_0_1304190][VENDOR];
}

unsigned short lge_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2810_SOAP_API_1889_0_0_1304190][DEVICE];
}

unsigned short lge_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2810_SOAP_API_1889_0_0_1304190][PROTOCOL];
}

unsigned short lge_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2810_SOAP_API_1889_0_0_1304190][VERSION];
}
...
unsigned short  lge_ptz_controller::move_up( unsigned short sensitive )
{
	...
	request.param->Parameter_USCORET[0]->value = soap_strdup( proxy.soap, "100" );
	...
	{
		unsigned int real_sensitive = get_sensitive_value( sensitive );
...
unsigned short  lge_ptz_controller::continuous_move_up( unsigned short sensitive )
{
	...
	request.param->Parameter_USCORET[0] = soap_new_ns1__Parameter_USCORET( proxy.soap, -1 );
	request.param->Parameter_USCORET[0]->key = soap_strdup( proxy.soap, "movespeed" );
	request.param->Parameter_USCORET[0]->value = soap_strdup( proxy.soap, "1" );
...
unsigned short  lge_ptz_controller::focus_far( unsigned short sensitive )
{
	...
	request.param->Parameter_USCORET = static_cast<ns1__Parameter_USCORET**>( soap_malloc(proxy.soap, sizeof(ns1__Parameter_USCORET*)*2) );
	request.param->Parameter_USCORET[0] = soap_new_ns1__Parameter_USCORET( proxy.soap, -1 );
	request.param->Parameter_USCORET[0]->key = soap_strdup( proxy.soap, "focusspeed" );
	request.param->Parameter_USCORET[0]->value = soap_strdup( proxy.soap, "100" );

	request.param->Parameter_USCORET[1] = soap_new_ns1__Parameter_USCORET( proxy.soap, -1 );
	request.param->Parameter_USCORET[1]->key = soap_strdup( proxy.soap, "focus" );
	request.param->Parameter_USCORET[1]->value = soap_strdup( proxy.soap, "far" );
...
unsigned short  lge_ptz_controller::focus_near( unsigned short sensitive )
{
	...
	request.param->Parameter_USCORET[1] = soap_new_ns1__Parameter_USCORET( proxy.soap, -1 );
	request.param->Parameter_USCORET[1]->key = soap_strdup( proxy.soap, "focus" );
	request.param->Parameter_USCORET[1]->value = soap_strdup( proxy.soap, "near" );
...
unsigned int lge_ptz_controller::get_sensitive_value( unsigned short sensitive )
{
	...
	else
	{
		...
		unsigned short real_sensitive = unsigned short( ceil(ratio*sensitive) );
