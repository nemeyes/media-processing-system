...
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_0_4][VENDOR];
}

char* onvif_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_0_4][DEVICE];
}

char* onvif_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_0_4][PROTOCOL];
}

char* onvif_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_0_4][VERSION];
}

unsigned short onvif_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_0_4][VENDOR];
}

unsigned short onvif_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_0_4][DEVICE];
}

unsigned short onvif_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_0_4][PROTOCOL];
}

unsigned short onvif_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_0_4][VERSION];
}
...
unsigned short onvif_ptz_controller::get_preset_list_map()
{
    ...
    //client.put_variable( "ch", "1" );	
	client.put_variable( "app", "get" );
	//결과값 :res=200&http_port=80&https_port=443&preset_home=0&preset_af_mode_type=3&def_preset_af_mode=1&preset_list=0,1,2,3,4,5   
