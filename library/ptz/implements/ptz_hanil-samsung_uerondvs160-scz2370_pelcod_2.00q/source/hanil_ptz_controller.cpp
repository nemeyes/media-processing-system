...
{
	return VMS_PTZ_DEVICE_INFO[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][VENDOR];
}

char* hanil_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][DEVICE];
}

char* hanil_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][PROTOCOL];
}

char* hanil_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][VERSION];
}

unsigned short hanil_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][VENDOR];
}

unsigned short hanil_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][DEVICE];
}

unsigned short hanil_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][PROTOCOL];
}

unsigned short hanil_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[HANIL_SAMSUNG_UERONDVS160_SCZ2370_PELCOD_V_2_00Q][VERSION];
}
