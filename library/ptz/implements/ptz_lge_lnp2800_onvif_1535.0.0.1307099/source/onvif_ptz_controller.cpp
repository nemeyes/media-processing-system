...
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2800_ONVIF_1535_0_0_1307099][VENDOR];
}

char* onvif_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2800_ONVIF_1535_0_0_1307099][DEVICE];
}

char* onvif_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2800_ONVIF_1535_0_0_1307099][PROTOCOL];
}

char* onvif_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LNP2800_ONVIF_1535_0_0_1307099][VERSION];
}

unsigned short onvif_ptz_controller::get_vendor_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2800_ONVIF_1535_0_0_1307099][VENDOR];
}

unsigned short onvif_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2800_ONVIF_1535_0_0_1307099][DEVICE];
}

unsigned short onvif_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2800_ONVIF_1535_0_0_1307099][PROTOCOL];
}

unsigned short onvif_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LNP2800_ONVIF_1535_0_0_1307099][VERSION];
}
