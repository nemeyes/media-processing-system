...
class http_client;
#if defined(WIN32)
class __declspec(dllexport) hikvision_ptz_controller : public base_ptz_controller
#else
class hikvision_ptz_controller : public base_ptz_controller
#endif
{
public:
	hikvision_ptz_controller( void );
	~hikvision_ptz_controller( void );
