...
class http_client;
#if defined(WIN32)
class __declspec(dllexport) panasonic_ptz_controller : public base_ptz_controller
#else
class panasonic_ptz_controller : public base_ptz_controller
#endif
{
public:
	panasonic_ptz_controller( void );
	~panasonic_ptz_controller( void );
