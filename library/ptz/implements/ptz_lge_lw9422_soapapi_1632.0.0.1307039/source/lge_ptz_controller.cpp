...
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW9422_SOAP_API_1632001307039][VENDOR];
}

char* lge_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW9422_SOAP_API_1632001307039][DEVICE];
}

char* lge_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW9422_SOAP_API_1632001307039][PROTOCOL];
}

char* lge_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[LGE_LW9422_SOAP_API_1632001307039][VERSION];
}

unsigned short lge_ptz_controller::get_vendor_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW9422_SOAP_API_1632001307039][VENDOR];
}

unsigned short lge_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW9422_SOAP_API_1632001307039][DEVICE];
}

unsigned short lge_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW9422_SOAP_API_1632001307039][PROTOCOL];
}

unsigned short lge_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[LGE_LW9422_SOAP_API_1632001307039][VERSION];
}
