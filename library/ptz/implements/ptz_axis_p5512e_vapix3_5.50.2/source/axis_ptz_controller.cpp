...
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512E_VAPIX_V3_5_50_2][VENDOR];
}

char* axis_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512E_VAPIX_V3_5_50_2][DEVICE];
}

char* axis_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512E_VAPIX_V3_5_50_2][PROTOCOL];
}

char* axis_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[AXIS_P5512E_VAPIX_V3_5_50_2][VERSION];
}

unsigned short axis_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[AXIS_P5512E_VAPIX_V3_5_50_2][VENDOR];
}

unsigned short axis_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[AXIS_P5512E_VAPIX_V3_5_50_2][DEVICE];
}

unsigned short axis_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[AXIS_P5512E_VAPIX_V3_5_50_2][PROTOCOL];
}

unsigned short axis_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[AXIS_P5512E_VAPIX_V3_5_50_2][VERSION];
}
...
{	
	...
	//axis-cgi/param.cgi?GuardTour%2eG0%2eRunning=yes&action=update
	http_client client( _host, _port_number, "/axis-cgi/param.cgi" );
...
{
	//axis-cgi/param.cgi?action=list&group=GuardTour%2e%2a%2eName
	//root.GuardTour.G0.Name=Guard Tour Name
...
unsigned short axis_ptz_controller::get_preset_tour_list(void)
{
	...
	//결과값:root.GuardTour.G0.Name=Guard Tour Name
	if( !client.send_request(_user_id, _user_password, recv_tours) ) 
	{
		client.clear_variable();
		return VMS_PTZ_FAIL;
