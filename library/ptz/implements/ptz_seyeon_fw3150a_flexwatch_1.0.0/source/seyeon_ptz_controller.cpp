...
{
	return VMS_PTZ_DEVICE_INFO[SEYEONTECH_FW3150A_10][VENDOR];
}

char* seyeon_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[SEYEONTECH_FW3150A_10][DEVICE];
}

char* seyeon_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[SEYEONTECH_FW3150A_10][PROTOCOL];
}

char* seyeon_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[SEYEONTECH_FW3150A_10][VERSION];
}

unsigned short seyeon_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[SEYEONTECH_FW3150A_10][VENDOR];
}

unsigned short seyeon_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[SEYEONTECH_FW3150A_10][DEVICE];
}

unsigned short seyeon_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[SEYEONTECH_FW3150A_10][PROTOCOL];
}

unsigned short seyeon_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[SEYEONTECH_FW3150A_10][VERSION];
}
