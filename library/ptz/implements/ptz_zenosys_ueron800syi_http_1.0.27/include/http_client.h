...
public:
	...
	bool			send_request( char *user_id, char *user_password, char *recv_buffer=0 );
	bool			post_request( char *user_id, char *user_password, char *send_buffer, int size_of_send_buffer, char **recv_buffer );
