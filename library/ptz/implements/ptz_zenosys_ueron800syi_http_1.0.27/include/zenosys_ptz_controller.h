...
class http_client;
#if defined(WIN32)
class __declspec(dllexport) zenosys_ptz_controller : public base_ptz_controller
#else
class zenosys_ptz_controller : public base_ptz_controller
#endif
{
public:
	zenosys_ptz_controller( void );
	~zenosys_ptz_controller( void );
