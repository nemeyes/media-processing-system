...
bool http_client::send_request( char *user_id, char *user_password, char *recv_buffer ) 
{
	bool result = false;
	...
	curl_easy_setopt( _curl, CURLOPT_HTTPAUTH, CURLAUTH_BASIC | CURLAUTH_DIGEST );
...
bool http_client::post_request( char *user_id, char *user_password, char *send_buffer, int size_of_send_buffer, char **recv_buffer )
{
	bool result = false;
	CURLcode curl_result;
	...
	slist = curl_slist_append( slist, "Content-Type: Multipart/related" );
	...
	curl_easy_setopt( _curl, CURLOPT_PASSWORD, user_password );
	curl_easy_setopt( _curl, CURLOPT_HTTPAUTH, CURLAUTH_BASIC | CURLAUTH_DIGEST );
	curl_easy_setopt( _curl, CURLOPT_POSTFIELDSIZE, size_of_send_buffer );
