...
{
	return VMS_PTZ_DEVICE_INFO[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][VENDOR];
}

char* hanil_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][DEVICE];
}

char* hanil_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][PROTOCOL];
}

char* hanil_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][VERSION];
}

unsigned short hanil_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][VENDOR];
}

unsigned short hanil_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][DEVICE];
}

unsigned short hanil_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][PROTOCOL];
}

unsigned short hanil_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[HANIL_HONEYWELL_UERONDVS160_HSDN251NS_PELCOD_V_2_00Q][VERSION];
}
...
{
	int preset_no = 0;
	sscanf(alias, "%d", &preset_no);
	if(preset_no>20) return VMS_PTZ_UNSUPPORTED_COMMAND;
	if(VMS_PTZ_FAIL == send_data("ADD_PRESET", preset_no)) return VMS_PTZ_FAIL;
...
unsigned short	hanil_ptz_controller::remove_preset( char *alias )
{
	...
	if(VMS_PTZ_FAIL == send_data("REMOVE_PRESET", preset_no)) return VMS_PTZ_FAIL;
	else return VMS_PTZ_SUCCESS;
}
...
unsigned short	hanil_ptz_controller::goto_preset( char *alias )
{
	...
	if(VMS_PTZ_FAIL == send_data("GOTO_PRESET", preset_no)) return VMS_PTZ_FAIL;
	else return VMS_PTZ_SUCCESS;
}
