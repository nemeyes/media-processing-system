...
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][VENDOR];
}

char* onvif_ptz_controller::get_vendor_device_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][DEVICE];
}

char* onvif_ptz_controller::get_vendor_device_protocol_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][PROTOCOL];
}

char* onvif_ptz_controller::get_vendor_device_version_name( void )
{
	return VMS_PTZ_DEVICE_INFO[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][VERSION];
}

unsigned short onvif_ptz_controller::get_vendor_id( void )
{

	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][VENDOR];
}

unsigned short onvif_ptz_controller::get_vendor_device_id( void )
{
	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][DEVICE];
}

unsigned short onvif_ptz_controller::get_vendor_device_protocol_id( void )
{
	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][PROTOCOL];
}

unsigned short onvif_ptz_controller::get_vendor_device_version_id( void )
{
	return VMS_PTZ_DEVICE_ID[HITRON_NFX_12053B1_ONVIF_V_1_2_3_X1_RELEASE][VERSION];
}
