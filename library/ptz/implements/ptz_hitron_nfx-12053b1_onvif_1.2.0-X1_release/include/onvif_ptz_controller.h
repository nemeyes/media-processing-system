...
private:
	...
	void            get_tour_speed( float speed, float &pan_speed, float &tilt_speed, float &zoom_speed );
	void            get_tour_quasi_speed( float pan_speed, float tilt_speed, float zoom_speed, float &speed );
...
private:
	...
	float				_min_cspeed;
	float				_max_cspeed;
	float	            _min_tour_pantilt_speed;
	float               _max_tour_pantilt_speed;
	float               _min_tour_zoom_speed;
	float               _max_tour_zoom_speed;
