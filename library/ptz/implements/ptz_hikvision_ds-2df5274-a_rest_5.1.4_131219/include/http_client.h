...
public:
	...
	bool			send_request( char *user_id, char *user_password, char* method, char *recv_buffer=0 );
	bool			send_request_with_data( char *user_id, char *user_password, char* method, char *send_buffer, char **recv_buffer=0);
