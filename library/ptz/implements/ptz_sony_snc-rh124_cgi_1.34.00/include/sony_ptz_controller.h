...
private:
	...
	std::map< std::string, std::string >  get_preset_list_map();	
	std::map< std::string, std::string >  get_preset_list_map_by_string(std::string raw_list_preset);
	unsigned short	make_current_presetposition_information( std::map<std::string, std::string> *preset_map );
	std::string     get_name_by_id( std::map<std::string,std::string> *preset_map, std::string id );	
	std::string     get_id_by_name(std::map<std::string,std::string> *preset_map, std::string name);
	unsigned short  remove_preset_tour_presets( const char *tour_no );
	int             get_max_abs_value( int a, int b );
