...
class __declspec(dllexport) lge_audio_backchannel_controller : public base_audio_backchannel_controller, public socket_client
{
public:
	lge_audio_backchannel_controller( void );
	~lge_audio_backchannel_controller( void );
