...
class live_rtsp_client : public RTSPClient
{
public:
	static live_rtsp_client * createNew(dk_live_rtsp_client * front, UsageEnvironment & env, const char * url, const char * username, const char * password, int transport_option, int recv_option, int recv_timeout, unsigned int http_port_number, bool * kill_flag);
...
protected:
	live_rtsp_client(dk_live_rtsp_client * front, UsageEnvironment & env, const char * url, const char * username, const char * password, int transport_option, int recv_option, int recv_timeout, unsigned int http_port_number, bool * kill_flag);
	~live_rtsp_client(void);
