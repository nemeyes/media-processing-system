...
h2645_buffer_sink::h2645_buffer_sink(dk_live_rtsp_client * front, dk_live_rtsp_client::VIDEO_SUBMEDIA_TYPE_T smt, UsageEnvironment & env, unsigned buffer_size, const char * vps, const char * sps, const char * pps)
