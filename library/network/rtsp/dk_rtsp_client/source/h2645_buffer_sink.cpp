...
h2645_buffer_sink::h2645_buffer_sink(debuggerking::rtsp_client * front, int32_t smt, UsageEnvironment & env, const char * vps, unsigned vps_size, const char * sps, unsigned sps_size, const char * pps, unsigned pps_size, unsigned buffer_size)
	: buffer_sink(front, debuggerking::rtsp_client::media_type_t::video, smt, env, buffer_size)
