...
{
public:
	h2645_buffer_sink(debuggerking::rtsp_client * front, int32_t smt, UsageEnvironment & env, const char * vps, unsigned vps_size, const char * sps, unsigned sps_size, const char * pps, unsigned pps_size, unsigned buffer_size);
