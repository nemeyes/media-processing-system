...
{
public:
	h2645_buffer_sink(dk_rtsp_client * front, dk_rtsp_client::VIDEO_SUBMEDIA_TYPE_T smt, UsageEnvironment & env, unsigned buffer_size, const char * vps, const char * sps = 0, const char * pps = 0);
