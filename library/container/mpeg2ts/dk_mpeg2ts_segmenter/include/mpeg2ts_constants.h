#ifndef _MPEG2TS_CONSTANTS_H_
#define _MPEG2TS_CONSTANTS_H_
...
#define TS_PACKET_ADAPTATION_FIELD_WITH_PAYLOAD 0x03
...
#define PES_PACKET_AUDIO_STREAM_ID_MASK			0xE0
#define PES_PACKET_AUDIO_STREAM_NUMBER_MASK		0x1F
#define PES_PACKET_VIDEO_STREAM_ID_MASK			0xF0
#define PES_PACKET_VIDEO_STREAM_NUMBER_MASK		0x0F

#define PES_PACKET_AUDIO_STREAM_ID		0xC0
#define PES_PACKET_VIDEO_STREAM_ID		0xE0

#define PES_PACKET_PTS_ONLY_VALUE		0x02
#define PES_PACKET_PTS_AND_DTS_VALUE	0x03
